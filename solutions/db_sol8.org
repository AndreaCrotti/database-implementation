...
*** Tupel Calculus: {n.person\_name,n.city | lives(n) \wedge \exists y (\wedge works(y) n.person\_name = y.person\_name \wedge y.salary < 10000 \wedge y.company\_name='MyComp') }
*** Domain Calculuis:
...
*** Relational Algebra:
    \pi_{company\_name} (\sigma_{C2='MyComp'\wedge city = city2}(located X p_{C2 \leftarrow company\_name}(p_{city2\leftarrwo company\_name (located))))
