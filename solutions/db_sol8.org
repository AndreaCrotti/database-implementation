...
#+begin_src sql
    select p.person_name, city from lives p join works w on p.person_name=w.person_name
...
#+begin_src sql
    ...
    union
    select lives.person_name from lives join works on lives.person_name=works.person_name
...
#+begin_src sql
    select p.person_name,p.city from lives p join works w on p.person_name=w.person_name
...
#+begin_src sql
    ...
    from boss m join works w on m.person_name=w.person_name
